...
export default {
  name: "UserForm",
  components: {ModalFormButtons, AppSelect, AppDatePicker, AppInput, AppTitle, Form, AppLoading, AppPassword},
  props: {
    isEdit: {
      type: Boolean,
      default: false
...
<template>
  ...
  <Form v-else @submit="onSubmit" :validation-schema="schema" v-slot="{ isSubmitting , meta}"
    ...
    <div class="form__end">
      ...
      <div class="form__row">
        ...
        <AppSelect item-title="name" item-value="id" label="Роль" name="role_id" :items="roles"/>
      </div>
      <div class="form__row">
